...
# --- HARD-CODED API KEY ---
GOOGLE_API_KEY = "AIzaSyCHg89y9oxyvXe4vjyUSSTG1ZtlXdqmeLY"  # Replace with your own key

# --- Streamlit UI ---
st.set_page_config(page_title="Project Management RAG App", layout="centered")
st.title("📊 Project Management Q&A App")
st.write("Upload your Project Management PDF and ask questions about it.")
